...
WEBKIT_OPTION_DEFINE(ENABLE_RDK_LOGGER "Whether to enable RDK logging" PUBLIC OFF)
...
WEBKIT_OPTION_DEFINE(USE_ODH_TELEMETRY "Whether to enable support for ODH telemetry." PUBLIC ON)
...
if (ENABLE_RDK_LOGGER)
    find_package(RdkLogger)
    if (NOT RdkLogger_FOUND)
        message(FATAL_ERROR "RdkLogger is needed for ENABLE_RDK_LOGGER")
    endif ()
endif ()

if (USE_ODH_TELEMETRY)
    find_package(OdhErrTelemetry)
    if (NOT OdhErrTelemetry_FOUND)
        message(FATAL_ERROR "OdhErrTelemetry is needed for USE_ODH_TELEMETRY")
    endif ()
    find_package(OdhOttTelemetry)
    if (NOT OdhOttTelemetry_FOUND)
        message(FATAL_ERROR "OdhOttTelemetry is needed for USE_ODH_TELEMETRY")
    endif ()
endif ()
