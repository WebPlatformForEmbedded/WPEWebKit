...
#ifndef MediaPlayerPrivateGStreamerPlaybin3Base_h
#define MediaPlayerPrivateGStreamerPlaybin3Base_h
...
class MediaPlayerPrivateGStreamerPlaybin3Base : public MediaPlayerPrivateInterface
#if USE(TEXTURE_MAPPER_GL)
...
public:
    virtual ~MediaPlayerPrivateGStreamerPlaybin3Base();
...
#if USE(TEXTURE_MAPPER_GL)
    PlatformLayer* platformLayer() const override { return const_cast<MediaPlayerPrivateGStreamerPlaybin3Base*>(this); }
...
protected:
    MediaPlayerPrivateGStreamerPlaybin3Base(MediaPlayer*);
    virtual GstElement* createVideoSink();

#if USE(GSTREAMER_GL)
    static GstFlowReturn newSampleCallback(GstElement*, MediaPlayerPrivateGStreamerPlaybin3Base*);
    static GstFlowReturn newPrerollCallback(GstElement*, MediaPlayerPrivateGStreamerPlaybin3Base*);
    ...
    static void repaintCallback(MediaPlayerPrivateGStreamerPlaybin3Base*, GstSample*);
    static void repaintCancelledCallback(MediaPlayerPrivateGStreamerPlaybin3Base*);

    void notifyPlayerOfVolumeChange();
    void notifyPlayerOfMute();

    static void volumeChangedCallback(MediaPlayerPrivateGStreamerPlaybin3Base*);
    static void muteChangedCallback(MediaPlayerPrivateGStreamerPlaybin3Base*);
    ...
    RunLoop::Timer<MediaPlayerPrivateGStreamerPlaybin3Base> m_drawTimer;
