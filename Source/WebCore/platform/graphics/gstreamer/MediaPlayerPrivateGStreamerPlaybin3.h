...
class AudioTrackPrivateGStreamerPlaybin3;
class InbandMetadataTextTrackPrivateGStreamer;
class InbandTextTrackPrivateGStreamer;
class MediaPlayerRequestInstallMissingPluginsCallback;
class VideoTrackPrivateGStreamerPlaybin3;

#if ENABLE(MEDIA_SOURCE)
class MediaSourcePrivateClient;
#endif

class MediaPlayerPrivateGStreamerPlaybin3 : public MediaPlayerPrivateGStreamerPlaybin3Base {
public:
    explicit MediaPlayerPrivateGStreamerPlaybin3(MediaPlayer*);
    virtual ~MediaPlayerPrivateGStreamerPlaybin3();
...
private:
    WeakPtr<MediaPlayerPrivateGStreamerPlaybin3> createWeakPtr() { return m_weakPtrFactory.createWeakPtr(*this); }
    WeakPtrFactory<MediaPlayerPrivateGStreamerPlaybin3> m_weakPtrFactory;
    ...
    static void uriDecodeBinElementAddedCallback(GstBin*, GstElement*, MediaPlayerPrivateGStreamerPlaybin3*);
    static void downloadBufferFileCreatedCallback(MediaPlayerPrivateGStreamerPlaybin3*);
...
protected:
    ...
    static void setAudioStreamPropertiesCallback(MediaPlayerPrivateGStreamerPlaybin3*, GObject*);

    static void sourceSetupCallback(MediaPlayerPrivateGStreamerPlaybin3*, GstElement*);
    static void videoChangedCallback(MediaPlayerPrivateGStreamerPlaybin3*);
    static void videoSinkCapsChangedCallback(MediaPlayerPrivateGStreamerPlaybin3*);
    static void audioChangedCallback(MediaPlayerPrivateGStreamerPlaybin3*);
#if ENABLE(VIDEO_TRACK)
    static void textChangedCallback(MediaPlayerPrivateGStreamerPlaybin3*);
    static GstFlowReturn newTextSampleCallback(MediaPlayerPrivateGStreamerPlaybin3*);
#endif
...
private:
    ...
    bool m_hasVideo;
    bool m_hasAudio;
    RunLoop::Timer<MediaPlayerPrivateGStreamerPlaybin3> m_readyTimerHandler;
...
#if ENABLE(VIDEO_TRACK)
    HashMap<AtomicString, RefPtr<AudioTrackPrivateGStreamerPlaybin3>> m_audioTracks;
    HashMap<AtomicString, RefPtr<InbandTextTrackPrivateGStreamer>> m_textTracks;
    HashMap<AtomicString, RefPtr<VideoTrackPrivateGStreamerPlaybin3>> m_videoTracks;
