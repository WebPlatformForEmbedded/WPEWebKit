...
RealtimeMediaSource::AudioCaptureFactory& RealtimeMediaSourceCenterLibWebRTC::defaultAudioFactory()
{
    return audioFactory();
}

RealtimeMediaSource::VideoCaptureFactory& RealtimeMediaSourceCenterLibWebRTC::defaultVideoFactory()
{
    return videoFactory();
}

CaptureDeviceManager& RealtimeMediaSourceCenterLibWebRTC::defaultAudioCaptureDeviceManager()
{
    return GStreamerAudioCaptureDeviceManager::singleton();
}

CaptureDeviceManager& RealtimeMediaSourceCenterLibWebRTC::defaultVideoCaptureDeviceManager()
{
