...
public:
    CaptureSourceOrError createAudioCaptureSource(const String& device, const MediaConstraints* constraints)
    {
        return GStreamerAudioCaptureSource::create(device, constraints);
    }
};
