...
webrtc::VideoDecoder* GStreamerVideoDecoderFactory::CreateVideoDecoderWithParams(webrtc::VideoCodecType type, cricket::VideoDecoderParams){
    return CreateVideoDecoder(type);
}

webrtc::VideoDecoder* GStreamerVideoDecoderFactory::CreateVideoDecoder(webrtc::VideoCodecType type)
{
    switch (type) {
